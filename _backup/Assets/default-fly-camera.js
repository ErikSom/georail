var DefaultFlyCamera = pc.createScript('defaultFlyCamera');

DefaultFlyCamera.attributes.add('speed', {
    type: 'number',
    default: 10
});

DefaultFlyCamera.attributes.add('fastSpeed', {
    type: 'number',
    default: 20
});

DefaultFlyCamera.attributes.add('mode', {
    type: 'number',
    default: 0,
    enum: [{
        'Lock': 0
...
DefaultFlyCamera.prototype.initialize = function () {
...
DefaultFlyCamera.prototype.update = function (dt) {
...
DefaultFlyCamera.prototype.onMouseMove = function (event) {
    if (!this.mode) {
...
DefaultFlyCamera.prototype.onMouseDown = function (event) {
    if (event.button === 0) {
        this.lmbDown = true;
...
DefaultFlyCamera.prototype.onMouseUp = function (event) {
    if (event.button === 0) {
        this.lmbDown = false;
    }
};